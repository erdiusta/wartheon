...
namespace Pathfinding {
	...
	public class EditorBase : Editor {
		...
		bool PropertyField (SerializedProperty prop, string label, string tooltip, string propertyPath) {
            ...
            if (Application.isPlaying && prop.propertyType == SerializedPropertyType.ObjectReference && prop.objectReferenceValue == null)
            {
                EditorGUILayout.HelpBox("Target will be assigned at runtime", MessageType.Info);
            }
            else
            {
