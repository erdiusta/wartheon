...
namespace Pathfinding {
	...
	public abstract class AIBase : VersionedMonoBehaviour {
		...
		/// </summary>
		public Vector3 desiredVelocity { get { return lastDeltaTime > 0.00001f ? movementPlane.ToWorld(lastDeltaPosition / 
			lastDeltaTime, verticalVelocity) : Vector3.zero; } }
		...
		public virtual void FinalizeMovement (Vector3 nextPosition, Quaternion nextRotation, Rigidbody2D rb2D = null) {
