...
public class PlayerSkillController : MonoBehaviour
{
    ...
    private void PerformShatterCry()
    {
        ...
        foreach (Collider2D col in colliders)
        {
            ...
            if (col.CompareTag(Settings.enemyTag))
            {
                ...
                {
                    IEnemyCombatData enemyCombatData = EnemyCombatDataResolver.Resolve(affectedEnemy.gameObject);
    ...
    public void AxeThrow(int slotIndex, ref ActiveUniqueSkillDetailsSO.LevelData activeSkillData)
    {
        ...
        player.meleeAttackEvent.CallAttackEvent(player.playerControl.aimDirection, offhandWeapon, offHandAttackType, MeleeHand.OffHand);
