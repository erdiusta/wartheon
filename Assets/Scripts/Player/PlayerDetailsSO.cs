...
public class PlayerDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Prefab gameobject for the single player")]
    #endregion
    public GameObject singlePlayerPrefab;
    #region Tooltip
    [Tooltip("Multiplayer Visuals")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckNullValue(this, nameof(singlePlayerPrefab), singlePlayerPrefab);
