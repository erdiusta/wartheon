...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    [HideInInspector] public RoomPropIndexer propIndexer;
    ...
    private void Awake()
    {
        ...
        propIndexer = GetComponent<RoomPropIndexer>();

        foreach (var prop in GetComponentsInChildren<RoomProp>(true))
        {
            prop.Room = this;
        }
    ...
    public Transform[] CreatePatrolTargets(Vector2Int[] spawnPositions, Transform parent = null)
    {
        ...
        for (int i = 0; i < spawnPositions.Length; i++)
        {
            ...
            PatrolPoint point = (PatrolPoint)PoolManager.Instance.ReuseComponent(GameResources.Instance.enemyPatrolPointsParent.gameObject, worldPos, Quaternion.identity);
