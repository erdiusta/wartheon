...
public class MeleeAttackOffHand : MonoBehaviour
{
    ...
    //{
    //    AttackWithOffHand(meleeAttackEventArgs.weapon, meleeAttackEventArgs.attackShape);
    //}
    ...
    //                        if (player.currentAttackRatingValue * 100 - enemy.enemyDetails.deflectionValue * 100 > Random.Range(0, 100))
    //                        {
    ...
    //    player.playerControl.meleeAttackTypeOffHand = AttackShape.None;
    //}

    //void AttackWithOffHand(Weapon weapon, AttackShape meleeAttackType)
    //{
