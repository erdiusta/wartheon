...
public class ActiveItemDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The using sound effect SO for the active item")]
    #endregion Tooltip
    public SoundEffectSO activeItemUseSoundEffect;
    ...
    #endregion Tooltip
    public int activeItemMaxCharge = 5;
    #region Tooltip
    [Tooltip("Active item charge regeneration per 6 unexplored rooms are explered")]
    #endregion Tooltip
    public int activeItemChargeRegenerationPerSixRooms = 1;
    ...
    #region Tooltip
    [Tooltip("The duration of item")]
    #endregion
    public float itemDuration = 20f;
    #region Tooltip
    ...
    #region Tooltip
    [Tooltip("Check if item has blind damage")]
    #endregion Tooltip
    public bool hasBlindDamage;
    #region Tooltip
    [Tooltip("The chance of item's blind")]
    #endregion Tooltip
