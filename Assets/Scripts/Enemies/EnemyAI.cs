...
public class EnemyAI : MonoBehaviour
{
    ...
    protected virtual void Awake()
    {
        ...
        if (!NetworkServer.active && !NetworkClient.active) player = GameManager.Instance.GetPlayer();
        else player = GameSessionManager.Instance.GetClosestPlayer(transform.position);
