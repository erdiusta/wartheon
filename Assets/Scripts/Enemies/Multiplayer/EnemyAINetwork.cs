...
public class EnemyAINetwork : NetworkBehaviour
{
    ...
    protected virtual void Awake()
    {
        ...
        enemyCombatData = EnemyCombatDataResolver.Resolve(gameObject);
    ...
    public override void OnStartServer()
    {
        ...
        player = GameSessionManager.Instance.GetClosestPlayer(transform.position);
    ...
    IEnumerator Server_WaitRoomAndInit()
    {
        ...
        // Safe to initialize
        enemy.patrol.targets = enemy.enemyNetwork.InstantiatedRoom.CreatePatrolTargets(enemy.enemyNetwork.SpawnPositions, patrolPointsParentContainer);
