...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_UINavigateInputActionProperty = serializedObject.FindProperty("uiNavigation");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_UINavigateInputActionProperty);
        ...
        private SerializedProperty m_UINavigateInputActionProperty;
